/* empty css             */import{_ as k}from"./FormCheckboxOrRadioGroup.vue_vue_type_script_setup_true_lang-CipljCb-.js";import{_ as v}from"./FormContainer.vue_vue_type_script_setup_true_lang-Dh9dw1V6.js";import"./vue.esm-bundler-Dl4EI7SU.js";import"./FormFieldset.vue_vue_type_script_setup_true_lang-qC-c9eIG.js";const A={title:"Elements/Form",parameters:{docs:{source:{code:null}}},tags:["!autodocs"],argTypes:{compact:{name:"Compact",control:{type:"boolean"},table:{category:"Modifiers"}},inline:{name:"Inline",control:{type:"boolean"},table:{category:"Modifiers"}},large:{name:"Large",control:{type:"boolean"},table:{category:"Modifiers"}},checked:{name:"Checked",control:{type:"boolean"},table:{category:"States"}},disabled:{name:"Disabled",control:{type:"boolean"},table:{category:"States"}},error:{name:"Error",control:{type:"boolean"},table:{category:"States"}},required:{name:"Required",control:{type:"boolean"},table:{category:"States"}},label:{table:{disable:!0}},type:{table:{disable:!0}},toggle:{table:{disable:!0}}},render:r=>({setup(){return{args:r,checkboxOptions:t,radioOptions:n}},components:{UidsFormCheckboxOrRadioGroup:k,UidsFormContainer:v},computed:{optionItems(){return r.type==="radio"?n:t}},template:`
