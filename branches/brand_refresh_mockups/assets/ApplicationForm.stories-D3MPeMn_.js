/* empty css                    *//* empty css                 *//* empty css                  *//* empty css             *//* empty css              */import{_ as t}from"./Button.vue_vue_type_script_setup_true_lang-DDyg8Vgf.js";import{B as s}from"./BrandBar-adAuNrqu.js";import{_ as o}from"./Menu.vue_vue_type_script_setup_true_lang-DJD3HX24.js";import"./vue.esm-bundler-Dl4EI7SU.js";/* empty css               */import"./utlity-BIMoNfdw.js";import"./Logo.vue_vue_type_script_setup_true_lang-HxhJmcm0.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const P={title:"Showcase/Application",tags:["!autodocs"],parameters:{layout:"fullscreen",docs:{source:{code:null}}}},n=[{label:"Home",url:"#",icon:"fas fa-house"},{label:"Directories",url:"#",icon:"fas fa-users",children:[]},{label:"Reports",url:"#",icon:"fas fa-file-lines"},{label:"Roles",url:"#",icon:"fas fa-user-gear"},{label:"Contact",url:"#",icon:"fas fa-mobile-screen"}],d=[{label:"Preview",url:"#"},{label:"Status",url:"#"},{label:"Memberships",url:"#"},{label:"Introduction",url:"#",active:!0},{label:"Profile Photo",url:"#"},{label:"Contacts",url:"#"},{label:"Websites",url:"#"},{label:"Positions",url:"#"},{label:"Education",url:"#"},{label:"Graduate Program Affiliations",url:"#"},{label:"Center, Program, and Institute Affiliations",url:"#"},{label:"Research Interests",url:"#"},{label:"Licenses & Certifications",url:"#"},{label:"Publications",url:"#"}],c={render:r=>({components:{UidsButton:t,BrandBar:s,UidsMenu:o},setup(){return{args:r,horizontalMenuItems:n,sidebarMenuItems:d}},template:`
      <main>
      <brand-bar
        :narrow='true'
        :healthcare='false'
