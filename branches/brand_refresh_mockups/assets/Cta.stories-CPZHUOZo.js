import{_ as c}from"./Cta.vue_vue_type_script_setup_true_lang-DN4053UA.js";import{B as b}from"./background-Dp_AVxiY.js";import"./vue.esm-bundler-Dl4EI7SU.js";/* empty css                    */import"./Headline.vue_vue_type_script_setup_true_lang-Dh65CvQC.js";/* empty css                  */import"./Button.vue_vue_type_script_setup_true_lang-NnvUBXdB.js";/* empty css               */import"./utlity-BIMoNfdw.js";const x={title:"Components/CTA",parameters:{docs:{source:{code:null}}},component:c,tags:["autodocs"],argTypes:{headline_style:{name:"Title style",options:["uppercase","serif",""],control:{type:"select",labels:{uppercase:"Antonio (default)",serif:"Zilla Slab","":"Roboto"}},table:{category:"Display options"}},orientation:{name:"Orientation",options:["","left","inline"],control:{type:"select",labels:{"":"Centered (default)",left:"Left",inline:"Inline"}},table:{category:"Display options"}},url:{control:{type:"text"}},title:{control:{type:"text"}},details:{control:{type:"text"}},button_label:{control:{type:"text"}},button_icon:{control:{type:"text"}},button_align_right:{name:"Align button to right",table:{category:"Display options"}},...b.argTypes}},a=m=>({components:{UidsCta:c},setup(){return{args:m}},template:`
    <uids-cta
      :url="args.url"
