import{k as d,c as p,f as m,a as N,p as u,q as k,n as W,x as D,o as h}from"./vue.esm-bundler-4mfmgVVP.js";import{_ as P}from"./Logo.vue_vue_type_script_setup_true_lang-CQJCCcxZ.js";import{_ as V}from"./_plugin-vue_export-helper-DlAUqK2U.js";import E from"./BrandBarDocs-BvfmOs1O.js";import"./index-DZw4_jV4.js";import"./iframe-uWkk8X9S.js";import"../sb-preview/runtime.js";import"./index-i39XpuQg.js";import"./index-D-8MO0q_.js";import"./index-DrFu-skq.js";import"./index-C3YA9a8X.js";import"./package-CvP6qD27.js";const q={name:"uids-iowa-bar",components:{UidsLogo:P},props:{narrow:{type:Boolean,default:!1},healthcare:{type:Boolean,default:!1}},setup(a,r){const l=d(()=>{let n=["iowa-bar"];return(a.narrow||r.slots.second_row_content)&&n.push("iowa-bar--narrow"),a.healthcare&&n.push("iowa-bar--healthcare"),n}),i=d(()=>r.slots.parent_title&&r.slots.parent_title().length||r.slots.bottom_content&&r.slots.bottom_content().length);return{getClasses:l,showBottomBar:i}}},x={class:"iowa-bar__container"},z={key:0,class:"iowa-bar__below"},L={class:"iowa-bar__container"};function M(a,r,l,i,n,j){const $=D("uids-logo");return h(),p("header",{class:W(i.getClasses),"data-uids-header":""},[m("div",x,[N($,{healthcare:l.healthcare,context:"header"},null,8,["healthcare"]),u(a.$slots,"default")]),a.$slots.second_row_content?(h(),p("div",z,[m("div",L,[u(a.$slots,"second_row_content")])])):k("",!0)],2)}const c=V(q,[["render",M]]),ra={title:"Components/Branding/Brand Bar",component:c,tags:["autodocs"],argTypes:{narrow:{control:{type:"boolean"}},default:{control:{type:"text"}},second_row_content:{control:{type:"text"}},healthcare:{control:{type:"boolean"}}},parameters:{docs:{source:{code:null},page:E}}},O=a=>({components:{UidsIowaBar:c},setup(){return{args:a}},template:`
