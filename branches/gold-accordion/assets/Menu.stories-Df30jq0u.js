import{_ as i}from"./Menu.vue_vue_type_script_setup_true_lang-CfiZPkcp.js";import"./vue.esm-bundler-ICYXiNBd.js";import"./utlity-CAV5GFHh.js";const g={title:"Components/Menu",parameters:{docs:{source:{code:null}}},component:i,tags:["autodocs"],argTypes:{variant:{control:{type:"select"},options:["horizontal","vertical"]}}},u={render:m=>({components:{UidsMenu:i},setup(){return{args:m}},template:`
