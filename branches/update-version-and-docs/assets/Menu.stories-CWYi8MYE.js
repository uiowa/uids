import{_ as i}from"./Menu.vue_vue_type_script_setup_true_lang-uHpZgjOJ.js";import"./iframe-CFF2vqm_.js";import"./preload-helper-DyDXPhph.js";import"./utlity-BIMoNfdw.js";const v={title:"Components/Menu",parameters:{docs:{source:{code:null}}},component:i,tags:["autodocs"],argTypes:{variant:{control:{type:"select"},options:["horizontal","vertical"]}}},u={render:m=>({components:{UidsMenu:i},setup(){return{args:m}},template:`
