import{i as e}from"./preload-helper-FXFgdrXs.js";import{t}from"./form-Ccp-uWbD.js";import{n,t as r}from"./FormContainer-CNx990_a.js";import{n as i,t as a}from"./FormCheckboxOrRadioGroup-R4SoD26x.js";var o,s,c,l,u,d,f,p;e((()=>{t(),i(),n(),o={title:`Elements/Form`,parameters:{docs:{source:{code:null}}},tags:[`!autodocs`],argTypes:{compact:{name:`Compact`,control:{type:`boolean`},table:{category:`Modifiers`}},inline:{name:`Inline`,control:{type:`boolean`},table:{category:`Modifiers`}},large:{name:`Large`,control:{type:`boolean`},table:{category:`Modifiers`}},checked:{name:`Checked`,control:{type:`boolean`},table:{category:`States`}},disabled:{name:`Disabled`,control:{type:`boolean`},table:{category:`States`}},error:{name:`Error`,control:{type:`boolean`},table:{category:`States`}},required:{name:`Required`,control:{type:`boolean`},table:{category:`States`}},label:{table:{disable:!0}},type:{table:{disable:!0}}},render:e=>({setup(){return{args:e,checkboxOptions:s,radioOptions:c}},components:{UidsFormCheckboxOrRadioGroup:a,UidsFormContainer:r},computed:{optionItems(){return e.type===`radio`?c:s}},template:`
