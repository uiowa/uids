import{_ as U}from"./Headline.vue_vue_type_script_setup_true_lang-B3QckQfw.js";import"./vue.esm-bundler-B7HU-66x.js";/* empty css                  */const F={title:"Components/Headline",parameters:{docs:{source:{code:null}}},component:U,tags:["autodocs"],argTypes:{default:{control:{type:"text"}},level:{control:{type:"select"},options:["h1","h2","h3","h4","h5","h6"]},highlight:{control:{type:"boolean"}},text_style:{type:Boolean,default:!1,options:["","uppercase","serif"],control:{type:"select",labels:{"":"default",uppercase:"Uppercase",serif:"Serif"}}},underline:{control:{type:"boolean"}},url:{control:{type:"text"}},aria_describedby:{control:{type:"text"}},class:{control:{type:"text"}}}},t=T=>({components:{UidsHeadline:U},setup(){return{args:T}},template:`
  ...
  \`
})`,...(w=(H=r.parameters)==null?void 0:H.docs)==null?void 0:w.source}}};const D=["Default","Uppercase","Serif","Underline","Highlight","HighlightedSingleWord"];export{e as Default,a as Highlight,r as HighlightedSingleWord,s as Serif,o as Underline,n as Uppercase,D as __namedExportsOrder,F as default};
