import"./vue.esm-bundler-B7HU-66x.js";/* empty css               */import{_ as w,a as f}from"./ExampleVideoFile-BLyY7sEK.js";const V={components:{ExampleImage:w,ExampleVideoFile:f},title:"Components/Media",tags:["!autodocs","!dev"],parameters:{docs:{source:{code:null}},options:{showPanel:!1}}},e={render:b=>({components:{ExampleImage:w},setup(){return{args:b}},template:`
      <example-image
        :src="args.src"
        :height="args.height"
        :width="args.width"
