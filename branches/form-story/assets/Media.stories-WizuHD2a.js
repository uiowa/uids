import"./vue.esm-bundler-CS6s2Jsr.js";/* empty css               */import{_ as w,a as f}from"./ExampleVideoFile-CVKLCBdV.js";const V={components:{ExampleImage:w,ExampleVideoFile:f},title:"Components/Media",tags:["!autodocs","!dev"],parameters:{docs:{source:{code:null}},options:{showPanel:!1}}},e={render:b=>({components:{ExampleImage:w},setup(){return{args:b}},template:`
      <example-image
        :src="args.src"
        :height="args.height"
        :width="args.width"
...
}`,...(g=(h=s.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};const y=["Image","EmbedVideo","VerticalVideo","HorizontalVideo"];export{a as EmbedVideo,s as HorizontalVideo,e as Image,t as VerticalVideo,y as __namedExportsOrder,V as default};
