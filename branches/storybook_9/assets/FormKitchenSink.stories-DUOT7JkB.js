import{d as u,u as m,e as i,b as a,L as v,l as d,o as t}from"./iframe-By4r0EcU.js";/* empty css             *//* empty css               */import{_ as c}from"./FormFieldset.vue_vue_type_script_setup_true_lang-DCt4GmU5.js";import{_ as f}from"./FormCheckboxOrRadioGroup.vue_vue_type_script_setup_true_lang-RkaJNVvH.js";import{_ as g}from"./FormContainer.vue_vue_type_script_setup_true_lang-CmCya4yx.js";import"./preload-helper-BfYMYwp6.js";const h={class:"form-item"},b={key:0,class:"form-item__description"},A=u({__name:"FormItem",setup(e){const s=m();return(n,x)=>(t(),i("div",h,[a(n.$slots,"default"),v(s).description?(t(),i("div",b,[a(n.$slots,"description")])):d("",!0)]))}}),T={title:"Elements/Form",parameters:{docs:{source:{code:null}}},tags:["!autodocs"],argTypes:{compact:{name:"Compact",table:{category:"Modifiers"}},large:{name:"Large",table:{category:"Modifiers"}},inline:{name:"Inline",table:{category:"Modifiers"}},flex:{name:"Flex",table:{category:"Modifiers"}},required:{name:"Required",control:{type:"boolean"},table:{category:"States"}}}},N=[{id:"text-permission-yes",name:"permission",value:!0,label:"Yes"},{id:"text-permission-no",name:"permission",value:!1,label:"No"}],M=[{id:"financial-aid",name:"interests",value:"FINANCIAL_AID",label:"Costs & Financial Aid"},{id:"marching-band",name:"interests",value:"MARCHING_BAND",label:"Hawkeye Marching Band"},{id:"rotc-air-force",name:"interests",value:"ROTC_AIR_FORCE",label:"ROTC - Air Force (Aerospace Studies)"},{id:"rotc-army",name:"interests",value:"ROTC_ARMY",label:"ROTC - Army (Military Science)"},{id:"study-abroad",name:"interests",value:"STUDY_ABROAD",label:"Study Abroad"},{id:"band",name:"interests",value:"BAND",label:"University Concert Bands and Jazz Bands"},{id:"honors",name:"interests",value:"HONORS",label:"University Honors Program"},{id:"veteran-services",name:"interests",value:"VETERAN_SERVICES",label:"Veteran & Military Connected Student Services"}],o={render:e=>({components:{UidsFormFieldset:c,UidsFormItem:A,UidsFormCheckboxOrRadioGroup:f,UidsFormContainer:g},setup(){return{args:e,radioOptions:N,checkboxOptions:M}},template:`
    ...
    `}),args:{large:!1,compact:!1,inline:!1,flex:!1,required:!0}};var l,r,p;o.parameters={...o.parameters,docs:{...(l=o.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: args => ({
    components: {
      UidsFormFieldset,
      UidsFormItem,
...
}`,...(p=(r=o.parameters)==null?void 0:r.docs)==null?void 0:p.source}}};const q=["KitchenSink"];export{o as KitchenSink,q as __namedExportsOrder,T as default};
