/* empty css             */import{_ as k}from"./FormCheckboxOrRadioGroup.vue_vue_type_script_setup_true_lang-RkaJNVvH.js";import{_ as h}from"./FormContainer.vue_vue_type_script_setup_true_lang-CmCya4yx.js";import"./iframe-By4r0EcU.js";import"./preload-helper-BfYMYwp6.js";import"./FormFieldset.vue_vue_type_script_setup_true_lang-DCt4GmU5.js";const _={title:"Elements/Form",parameters:{docs:{source:{code:null}}},tags:["!autodocs"],argTypes:{compact:{name:"Compact",control:{type:"boolean"},table:{category:"Modifiers"}},inline:{name:"Inline",control:{type:"boolean"},table:{category:"Modifiers"}},large:{name:"Large",control:{type:"boolean"},table:{category:"Modifiers"}},checked:{name:"Checked",control:{type:"boolean"},table:{category:"States"}},disabled:{name:"Disabled",control:{type:"boolean"},table:{category:"States"}},error:{name:"Error",control:{type:"boolean"},table:{category:"States"}},required:{name:"Required",control:{type:"boolean"},table:{category:"States"}},label:{table:{disable:!0}},type:{table:{disable:!0}}},render:r=>({setup(){return{args:r,checkboxOptions:t,radioOptions:i}},components:{UidsFormCheckboxOrRadioGroup:k,UidsFormContainer:h},computed:{optionItems(){return r.type==="radio"?i:t}},template:`
