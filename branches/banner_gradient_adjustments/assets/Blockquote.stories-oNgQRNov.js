import{d as w,g as $,c as o,F as g,j as c,q as s,f as m,t as l,e as p,n as j,o as n}from"./vue.esm-bundler-6yBGeiij.js";/* empty css                    *//* empty css               */import{B as u}from"./background-DvwhyV5E.js";import{c as T}from"./utlity-CAV5GFHh.js";const U={key:0,class:"blockquote__media media--circle"},H={class:"blockquote__content"},A={key:0,class:"blockquote__paragraph"},D={key:0,class:"blockquote__media media--circle"},M={key:0,href:"{{ url }}"},B=w({__name:"Blockquote",props:{media_position_bottom:{type:Boolean,default:!0},content:{type:String},footer:{type:String},url:{type:String},cite_text:{type:String},orientation:{type:String,default:""},...u.props},setup(t){const d=t,S=$(()=>{let e=["blockquote"];return u.addBackgroundClass(e,d),d.orientation&&e.push(`blockquote--${T(d.orientation)}`),e});return(e,z)=>(n(),o("blockquote",{class:j([...S.value,{[`blockquote--img-${t.media_position_bottom?"below":"above"}`]:e.$slots.media}])},[t.media_position_bottom?s("",!0):(n(),o(g,{key:0},[e.$slots.media?(n(),o("div",U,[c(e.$slots,"media")])):s("",!0)],64)),m("div",H,[t.content?(n(),o("div",A,[c(e.$slots,"content",{},()=>[p(l(t.content),1)])])):s("",!0),m("footer",null,[t.media_position_bottom?(n(),o(g,{key:0},[e.$slots.media?(n(),o("div",D,[c(e.$slots,"media")])):s("",!0)],64)):s("",!0),m("div",null,[c(e.$slots,"footer",{},()=>[p(l(t.footer),1)]),m("cite",null,[t.url?(n(),o("a",M,l(t.cite_text),1)):(n(),o(g,{key:1},[p(l(t.cite_text),1)],64))])])])])],2))}}),N="/branches/banner_gradient_adjustments/assets/herky-square-loMo5jDD.jpg",E={title:"Components/Blockquote",parameters:{docs:{source:{code:null}}},component:B,tags:["autodocs"],argTypes:{orientation:{name:"Orientation",options:["","center","right"],control:{type:"select",labels:{"":"Left (default)",center:"Center",right:"Right"}},table:{category:"Display options"}},url:{control:{type:"text"}},media_position_bottom:{control:{type:"boolean"}},footer:{control:{type:"text"}},cite_text:{control:{type:"text"}},content:{control:{type:"text"}},media:{name:"Media",control:"text",table:{category:"Media"}},...u.argTypes}},h=t=>({components:{UidsBlockquote:B},setup(){return{args:t}},template:`
  ...
  \`
})`,...(x=(C=i.parameters)==null?void 0:C.docs)==null?void 0:x.source}}};const O=["Left","Centered","Right"];export{r as Centered,a as Left,i as Right,O as __namedExportsOrder,E as default};
