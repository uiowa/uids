import{g as d,c as p,f as m,a as N,j as u,q as W,n as k,y as D,o as h}from"./vue.esm-bundler-CS6s2Jsr.js";import{_ as P}from"./Logo.vue_vue_type_script_setup_true_lang-B-WVss6K.js";import{_ as V}from"./_plugin-vue_export-helper-DlAUqK2U.js";import E from"./BrandBarDocs-Bx9pcO8X.js";import"./index-D6wmGqI3.js";import"./iframe-Ckh8Qfk6.js";import"../sb-preview/runtime.js";import"./index-i39XpuQg.js";import"./index-D-8MO0q_.js";import"./index-DrFu-skq.js";import"./index-cVPqMio7.js";import"./package-CvWI4E4G.js";const j={name:"uids-iowa-bar",components:{UidsLogo:P},props:{narrow:{type:Boolean,default:!1},healthcare:{type:Boolean,default:!1}},setup(a,r){const l=d(()=>{let n=["iowa-bar"];return(a.narrow||r.slots.second_row_content)&&n.push("iowa-bar--narrow"),a.healthcare&&n.push("iowa-bar--healthcare"),n}),i=d(()=>r.slots.parent_title&&r.slots.parent_title().length||r.slots.bottom_content&&r.slots.bottom_content().length);return{getClasses:l,showBottomBar:i}}},q={class:"iowa-bar__container"},z={key:0,class:"iowa-bar__below"},L={class:"iowa-bar__container"};function M(a,r,l,i,n,x){const $=D("uids-logo");return h(),p("header",{class:k(i.getClasses),"data-uids-header":""},[m("div",q,[N($,{healthcare:l.healthcare,context:"header"},null,8,["healthcare"]),u(a.$slots,"default")]),a.$slots.second_row_content?(h(),p("div",z,[m("div",L,[u(a.$slots,"second_row_content")])])):W("",!0)],2)}const c=V(j,[["render",M]]),ra={title:"Components/Branding/Brand Bar",component:c,tags:["autodocs"],argTypes:{narrow:{control:{type:"boolean"}},default:{control:{type:"text"}},second_row_content:{control:{type:"text"}},healthcare:{control:{type:"boolean"}}},parameters:{docs:{source:{code:null},page:E}}},O=a=>({components:{UidsIowaBar:c},setup(){return{args:a}},template:`
