import"./iframe-CEK89M90.js";/* empty css               */import{_ as w,a as f}from"./ExampleVideoFile-D_Rx2pWy.js";import"./preload-helper-C6G9HS8-.js";const y={components:{ExampleImage:w,ExampleVideoFile:f},title:"Components/Media",tags:["!autodocs","!dev"],parameters:{docs:{source:{code:null}},options:{showPanel:!1}}},e={render:b=>({components:{ExampleImage:w},setup(){return{args:b}},template:`
      <example-image
        :src="args.src"
        :height="args.height"
        :width="args.width"
