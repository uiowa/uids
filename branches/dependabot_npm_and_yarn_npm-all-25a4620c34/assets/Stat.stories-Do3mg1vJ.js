import{i as e}from"./preload-helper-DCtgd561.js";import{C as t,D as n,E as r,F as i,G as a,j as o,k as s,q as c,w as l,x as u}from"./iframe-C_wkEyci.js";import{t as d}from"./_background-BnqOB3JI.js";import{n as f,t as p}from"./background-CmzkK7IR.js";import{i as m,n as h,r as g,t as _}from"./GridItem-DBP-j3I5.js";var v=e((()=>{})),y,b,x,S,C,w,T,E=e((()=>{u(),v(),d(),f(),y={key:0},b={class:`stat__title`},x={key:0,class:`headline__prefix`},S={key:1,class:`headline__suffix`},C=[`innerHTML`],w=[`innerHTML`],T=o({__name:`Stat`,props:{stat_title:{type:String,default:``},stat_summary:{type:String,default:``},stat_content:{type:String,default:``},stat_prefix:{type:String,default:``},stat_suffix:{type:String,default:``},stat_hover:{type:Boolean,default:!0},display:{type:String,default:`default`,validator:e=>[`default`,`horizontal`].includes(e)},...p.props},setup(e){let o=e,u=t(()=>{let e=[];return p.addBackgroundClass(e,o),o.display===`horizontal`?e.push(`stat--horizontal`,`stat__grid`):e.push(`element--flex-center`),o.stat_hover||e.push(`stat--static`),e});return(t,o)=>(i(),n(`div`,{class:a([`stat`,`stat__grid`,`stat--transform`,...u.value])},[e.stat_title?(i(),n(`div`,y,[l(`h2`,b,[e.stat_prefix?(i(),n(`span`,x,c(e.stat_prefix),1)):r(``,!0),s(` `+c(e.stat_title)+` `,1),e.stat_suffix?(i(),n(`span`,S,c(e.stat_suffix),1)):r(``,!0)])])):r(``,!0),e.stat_summary?(i(),n(`span`,{key:1,class:`stat__description`,innerHTML:e.stat_summary},null,8,C)):r(``,!0),e.stat_content?(i(),n(`p`,{key:2,class:`stat__content`,innerHTML:e.stat_content},null,8,w)):r(``,!0)],2))}})})),D,O=e((()=>{E(),E(),D=T})),k,A,j,M,N,P,F;e((()=>{O(),f(),m(),h(),k={title:`Components/Stat`,component:D,tags:[`autodocs`],argTypes:{display:{control:`select`,name:`Display`,options:[`default`,`horizontal`]},stat_title:{control:`text`,name:`Title`},stat_summary:{control:`text`,name:`Summary`},stat_content:{control:`text`,name:`Content`},stat_prefix:{control:`text`,name:`Prefix`},stat_suffix:{control:`text`,name:`Suffix`},stat_hover:{name:`Hover`},...p.argTypes}},A=e=>({components:{UidsStat:D},setup(){return{args:e}},template:`<uids-stat v-bind="args" />`}),j=A.bind({}),j.args={display:`default`,stat_title:`15:1`,stat_summary:`student-to-faculty ratio`,stat_content:`Among the top 2% of universities worldwide.`,stat_prefix:``,stat_suffix:`+`,stat_hover:!0},M=A.bind({}),M.args={display:`horizontal`,stat_title:`15:1`,stat_summary:`student-to-faculty<br /> ratio`,stat_content:`Among the top 2% of universities worldwide.`,stat_hover:!0},N=e=>({components:{UidsGrid:g,UidsGridItem:_,UidsStat:D},setup(){return{args:e}},template:`
