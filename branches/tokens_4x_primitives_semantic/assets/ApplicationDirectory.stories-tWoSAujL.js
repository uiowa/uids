import{i as e}from"./preload-helper-fGSbh7xu.js";import{t}from"./_background-BWItl8tW.js";import{n,t as r}from"./Button-CrbviYk1.js";import{t as i}from"./_headline-Dw2Nq3Ws.js";import{t as a}from"./_grid-CbM219EP.js";import{n as o,t as s}from"./BrandBar-BpYunWff.js";import{t as c}from"./form-DT91s4L_.js";import{n as l,t as u}from"./ExampleFiltersForm-BHDJg_qY.js";import{n as d,t as f}from"./Menu-BMzbpjVB.js";import{n as p,t as m}from"./_flexbox-BXdAgVD0.js";import{n as h,t as g}from"./Table-BJG-bwoG.js";var _=e((()=>{})),v,y,b,x,S;e((()=>{t(),p(),i(),c(),_(),m(),a(),n(),o(),h(),d(),l(),v={subcomponents:{ExampleFiltersForm:u},title:`Showcase/Application`,tags:[`!autodocs`],parameters:{layout:`fullscreen`,docs:{source:{code:null}}},argTypes:{showSidebar:{name:`Show sidebar`}}},y=[{label:`Home`,url:`#`,icon:`fas fa-house`},{label:`Directories`,url:`#`,icon:`fas fa-users`,children:[]},{label:`Reports`,url:`#`,icon:`fas fa-file-lines`},{label:`Roles`,url:`#`,icon:`fas fa-user-gear`},{label:`Contact`,url:`#`,icon:`fas fa-mobile-screen`}],b={render:e=>({components:{UidsButton:r,BrandBar:s,UidsTable:g,UidsMenu:f,ExampleFiltersForm:u},setup(){return{args:e,horizontalMenuItems:y}},template:`
      <main>
        <brand-bar
          :narrow='true'
          :healthcare='false'
