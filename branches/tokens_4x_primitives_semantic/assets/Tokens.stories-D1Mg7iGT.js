import{i as e}from"./preload-helper-fGSbh7xu.js";import{X as t,lt as n,vt as r}from"./iframe-D2F7siRc.js";function i(){let e=new Map;for(let t of document.styleSheets){let n;try{n=t.cssRules}catch{continue}for(let t of n)if(!(!t.style||!t.selectorText))for(let n of t.style)n.startsWith(`--uiowa-`)&&e.set(n,t.style.getPropertyValue(n).trim())}return e}function a(e,t){let n=e.replace(`--uiowa-`,``);return n.startsWith(`typography-`)?`type style`:n.startsWith(`color-`)?t.startsWith(`var(`)?`color role`:`color primitive`:n.startsWith(`space-`)?`space`:n.startsWith(`layout-`)?`layout`:/^(font|line)-/.test(n)?`type primitive`:`other`}var o,s,c,l,u,d,f,p,m,h,g,_;e((()=>{t(),o=e=>e.replace(/^var\(\s*/,``).replace(/\s*\)$/,``),s=e=>getComputedStyle(document.documentElement).getPropertyValue(e).trim(),c={"font-family":`fontFamily`,"font-weight":`fontWeight`,"font-size":`fontSize`,"line-height":`lineHeight`},l=e=>(e.match(/^--uiowa-(font-family|font-weight|font-size|line-height)-/)||[])[1],u=e=>({[c[e.kind]]:`var(${e.name})`}),d=()=>{let e=r([]);return n(()=>{e.value=[...i()].map(([e,t])=>({name:e,declared:t,value:s(e),group:a(e,t),kind:l(e)}))}),e},f=`
