import{i as e}from"./preload-helper-fGSbh7xu.js";import{t}from"./_background-BWItl8tW.js";import n,{t as r}from"./Background.stories-D_5wQVGF.js";import{n as i,t as a}from"./Button-hMWGaaGP.js";import{t as o}from"./_headline-Dw2Nq3Ws.js";import{t as s}from"./_grid-CbM219EP.js";import{i as c,n as l,r as u,t as d}from"./GridItem-7yJUeNyX.js";import{t as f}from"./blockquote-ClCjS5MG.js";import{n as p,t as m}from"./BrandBar-B1DAij4z.js";import{n as h,t as g}from"./Card-B76QPbPI.js";import{n as _,t as v}from"./Menu-ChabhXIB.js";import{n as y,t as b}from"./_flexbox-BXdAgVD0.js";import{t as x}from"./tables-C8zygDFS.js";import{n as S,t as C}from"./Stat-Sj5cYvm6.js";var w,T,E,D,O,k;e((()=>{t(),y(),o(),f(),x(),s(),b(),p(),i(),h(),c(),l(),_(),S(),r(),w=[{label:`Academics`,url:`#`},{label:`Research`,url:`#`},{label:`Admissions`,url:`#`},{label:`About`,url:`#`}],T=[{title:`Undergraduate`,body:`Four-year degrees across sixty departments, with research placements from the first year.`},{title:`Graduate`,body:`Master's and doctoral study, taught by faculty who publish in the fields they teach.`},{title:`Professional`,body:`Part-time and evening programs built for people already working in their field.`}],E={title:`Showcase/Landing page`,tags:[`!autodocs`],parameters:{layout:`fullscreen`,docs:{source:{code:null}}},argTypes:{intro_background:{...n.argTypes.section_background,name:`Intro section`},programs_background:{...n.argTypes.section_background,name:`Programs section`},panel_background:{...n.argTypes.section_background,name:`Nested panel`},cta_background:{...n.argTypes.section_background,name:`Closing section`}}},D={render:e=>({components:{BrandBar:m,UidsButton:a,UidsCard:g,UidsGrid:u,UidsGridItem:d,UidsMenu:v,UidsStat:C},setup(){return{args:e,menuItems:w,programs:T}},template:`
      <main>
    ...
    `})},O={...D,args:{intro_background:``,programs_background:`bg--gray`,panel_background:`bg--white`,cta_background:`bg--black`}},O.parameters={...O.parameters,docs:{...O.parameters?.docs,source:{originalSource:`{
  ...Template,
  args: {
    intro_background: '',
...
}`,...O.parameters?.docs?.source}}},k=[`LandingPage`]}))();export{O as LandingPage,k as __namedExportsOrder,E as default};