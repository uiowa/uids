...
`,u={title:`Tokens`,tags:[`!autodocs`],parameters:{layout:`fullscreen`,docs:{source:{code:null}}}},d={render:()=>({setup(){return{tokens:c(),primitiveOf:o,css:l}},template:`
      <div class="tk">
    ...
    `})},p={name:`Space and layout`,render:()=>({setup(){return{tokens:c(),css:l}},template:`
      <div class="tk">
        <component is="style">{{ css }}</component>
...
}`,...p.parameters?.docs?.source}}},m=[`Colors`,`Typography`,`SpaceAndLayout`]}))();export{d as Colors,p as SpaceAndLayout,f as Typography,m as __namedExportsOrder,u as default};