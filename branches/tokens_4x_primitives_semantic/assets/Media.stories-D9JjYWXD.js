import{i as e}from"./preload-helper-fGSbh7xu.js";import{t}from"./_media-CQNCG522.js";import{n,t as r}from"./ExampleImage-CEIgNUcN.js";import{n as i,t as a}from"./ExampleVideoFile-hj1jH673.js";import{n as o}from"./Media-CMhrj5i2.js";var s,c,l,u,d,f;e((()=>{o(),t(),n(),i(),s={components:{ExampleImage:r,ExampleVideoFile:a},title:`Components/Media`,tags:[`!autodocs`,`!dev`],parameters:{docs:{source:{code:null}},options:{showPanel:!1}}},c={render:e=>({components:{ExampleImage:r},setup(){return{args:e}},template:`
      <example-image
        :src="args.src"
        :height="args.height"
        :width="args.width"
