import{i as e}from"./preload-helper-fGSbh7xu.js";import{t}from"./_background-BWItl8tW.js";import{n,t as r}from"./Button-B8IWEAFU.js";import{t as i}from"./_headline-Dw2Nq3Ws.js";import{t as a}from"./_grid-DZmDGna5.js";import{n as o,t as s}from"./BrandBar-DqGNfjna.js";import{t as c}from"./form-BBRT8I-p.js";import{n as l,t as u}from"./ExampleFiltersForm-DUiZ9clg.js";import{n as d,t as f}from"./Menu-BBD7Kgk1.js";import{t as p}from"./_border-DhwFjAmk.js";import{t as m}from"./_flexbox-DM4YBzJl.js";import{n as h,t as g}from"./Table-B_HEGJo6.js";var _=e((()=>{})),v,y,b,x,S;e((()=>{t(),p(),i(),c(),_(),m(),a(),n(),o(),h(),d(),l(),v={subcomponents:{ExampleFiltersForm:u},title:`Showcase/Application`,tags:[`!autodocs`],parameters:{layout:`fullscreen`,docs:{source:{code:null}}},argTypes:{showSidebar:{name:`Show sidebar`}}},y=[{label:`Home`,url:`#`,icon:`fas fa-house`},{label:`Directories`,url:`#`,icon:`fas fa-users`,children:[]},{label:`Reports`,url:`#`,icon:`fas fa-file-lines`},{label:`Roles`,url:`#`,icon:`fas fa-user-gear`},{label:`Contact`,url:`#`,icon:`fas fa-mobile-screen`}],b={render:e=>({components:{UidsButton:r,BrandBar:s,UidsTable:g,UidsMenu:f,ExampleFiltersForm:u},setup(){return{args:e,horizontalMenuItems:y}},template:`
      <main>
        <brand-bar
          :narrow='true'
          :healthcare='false'
