import{i as e}from"./preload-helper-fGSbh7xu.js";import{Q as t,X as n,lt as r,vt as i}from"./iframe-C8bNmJ1S.js";function a(){let e=new Map;for(let t of document.styleSheets){let n;try{n=t.cssRules}catch{continue}for(let t of n)if(!(!t.style||!t.selectorText))for(let n of t.style)n.startsWith(`--uiowa-`)&&e.set(n,t.style.getPropertyValue(n).trim())}return e}function o(e,t){let n=e.replace(`--uiowa-`,``);return n.startsWith(`typography-`)?`type style`:n.startsWith(`color-`)?t.startsWith(`var(`)?`color role`:`color primitive`:n.startsWith(`space-`)?`space`:n.startsWith(`layout-`)?`layout`:/^(font|letter|line)-/.test(n)?`type primitive`:`other`}var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x;e((()=>{n(),s=[{name:`font-family`,property:`fontFamily`},{name:`font-weight`,property:`fontWeight`},{name:`font-size`,property:`fontSize`},{name:`letter-spacing`,property:`letterSpacing`},{name:`line-height`,property:`lineHeight`}],c=RegExp(`-(${s.map(({name:e})=>e).join(`|`)})$`),l=e=>e.replace(/^var\(\s*/,``).replace(/\s*\)$/,``),u=e=>getComputedStyle(document.documentElement).getPropertyValue(e).trim(),d=Object.fromEntries(s.map(({name:e,property:t})=>[e,t])),f=e=>(e.match(RegExp(`^--uiowa-(${s.map(({name:e})=>e).join(`|`)})-`))||[])[1],p=e=>({[d[e.kind]]:`var(${e.name})`}),m=e=>Object.fromEntries(s.map(({name:t,property:n})=>[n,`var(${e}-${t})`])),h=()=>{let e=i([]);return r(()=>{e.value=[...a()].map(([e,t])=>({name:e,declared:t,value:u(e),group:o(e,t),kind:f(e)}))}),e},g=`
