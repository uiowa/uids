import{i as e}from"./preload-helper-fGSbh7xu.js";import{t}from"./_media-CQNCG522.js";import{i as n,n as r,r as i,t as a}from"./ExampleVideoFile-DFkEN0XS.js";import{n as o}from"./Media-ByDH_kCC.js";var s,c,l,u,d,f;e((()=>{o(),t(),n(),r(),s={components:{ExampleImage:i,ExampleVideoFile:a},title:`Components/Media`,tags:[`!autodocs`,`!dev`],parameters:{docs:{source:{code:null}},options:{showPanel:!1}}},c={render:e=>({components:{ExampleImage:i},setup(){return{args:e}},template:`
      <example-image
        :src="args.src"
        :height="args.height"
        :width="args.width"
