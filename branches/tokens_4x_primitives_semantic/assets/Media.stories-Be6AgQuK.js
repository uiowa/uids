import{i as e}from"./preload-helper-fGSbh7xu.js";import{t}from"./_media-CQNCG522.js";import{n,t as r}from"./ExampleImage-Dkb-pfHs.js";import{n as i,t as a}from"./ExampleVideoFile-BayTnci0.js";import{n as o}from"./Media-BkvMCK0G.js";var s,c,l,u,d,f;e((()=>{o(),t(),n(),i(),s={components:{ExampleImage:r,ExampleVideoFile:a},title:`Components/Media`,tags:[`!autodocs`,`!dev`],parameters:{docs:{source:{code:null}},options:{showPanel:!1}}},c={render:e=>({components:{ExampleImage:r},setup(){return{args:e}},template:`
      <example-image
        :src="args.src"
        :height="args.height"
        :width="args.width"
