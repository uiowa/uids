import{i as e}from"./preload-helper-fGSbh7xu.js";import{t}from"./_background-BMQi4Pne.js";import{n,t as r}from"./Button-DQx29B_P.js";import{t as i}from"./_headline-CvTJ5D-u.js";import{t as a}from"./_grid-DZmDGna5.js";import{n as o,t as s}from"./BrandBar-JFvhEr-o.js";import{t as c}from"./form-CpPX0At7.js";import{n as l,t as u}from"./ExampleFiltersForm-Cz5EYkaS.js";import{n as d,t as f}from"./Menu-F6IUYnmV.js";import{n as p,t as m}from"./_flexbox-CoE_T4Ar.js";import{n as h,t as g}from"./Table-Dkid5a_K.js";var _=e((()=>{})),v,y,b,x,S;e((()=>{t(),p(),i(),c(),_(),m(),a(),n(),o(),h(),d(),l(),v={subcomponents:{ExampleFiltersForm:u},title:`Showcase/Application`,tags:[`!autodocs`],parameters:{layout:`fullscreen`,docs:{source:{code:null}}},argTypes:{showSidebar:{name:`Show sidebar`}}},y=[{label:`Home`,url:`#`,icon:`fas fa-house`},{label:`Directories`,url:`#`,icon:`fas fa-users`,children:[]},{label:`Reports`,url:`#`,icon:`fas fa-file-lines`},{label:`Roles`,url:`#`,icon:`fas fa-user-gear`},{label:`Contact`,url:`#`,icon:`fas fa-mobile-screen`}],b={render:e=>({components:{UidsButton:r,BrandBar:s,UidsTable:g,UidsMenu:f,ExampleFiltersForm:u},setup(){return{args:e,horizontalMenuItems:y}},template:`
      <main>
        <brand-bar
          :narrow='true'
          :healthcare='false'
