import{d as D,k as m,c as r,f as U,a as b,b as _,m as d,l,n as h,o as u,e as g,t as y}from"./vue.esm-bundler--ETYdinE.js";/* empty css                    */import{_ as V}from"./Headline.vue_vue_type_script_setup_true_lang-Bzaie0v3.js";import{_ as j}from"./Button.vue_vue_type_script_setup_true_lang-DZHdLx2E.js";import{B as c}from"./background-DvwhyV5E.js";import{c as f}from"./utlity-CAV5GFHh.js";const E={class:"cta__container"},L={key:0,class:"cta__title"},z={key:1,class:"cta__content"},O={key:0,class:"cta__link"},A=D({__name:"Cta",props:{headline_style:{type:String,default:""},url:{type:String},details:{type:String},orientation:{type:String,default:""},button_align_right:{type:Boolean,default:!1},button_label:{type:String},button_icon:{type:String,default:""},...c.props},setup(e){const i=e,I=m(()=>{let t=["cta"];return c.addBackgroundClass(t,i),["button_align_right"].forEach(a=>{i[a]===!0&&t.push(`cta--${f(a)}`)}),i.orientation&&t.push(`cta--${f(i.orientation)}`),t}),N=m(()=>[""]);return(t,a)=>(u(),r("div",{class:h(I.value)},[U("div",E,[t.$slots.title?(u(),r("div",L,[b(V,{text_style:e.headline_style},{default:_(()=>[l(t.$slots,"title",{},()=>[a[0]||(a[0]=g("Title"))])]),_:3},8,["text_style"])])):d("",!0),e.details?(u(),r("div",z,[l(t.$slots,"details",{},()=>[g(y(e.details),1)])])):d("",!0)]),e.button_label?(u(),r("footer",O,[b(j,{class:h(N.value),url:e.url,size:"medium"},{default:_(()=>[l(t.$slots,"button_label",{},()=>[g(y(e.button_label),1)]),l(t.$slots,"button_icon")]),_:3},8,["class","url"])])):d("",!0)],2))}}),J={title:"Components/CTA",parameters:{docs:{source:{code:null}}},component:A,tags:["autodocs"],argTypes:{headline_style:{name:"Title style",options:["uppercase","serif",""],control:{type:"select",labels:{uppercase:"Antonio (default)",serif:"Zilla Slab","":"Roboto"}},table:{category:"Display options"}},orientation:{name:"Orientation",options:["","left","inline"],control:{type:"select",labels:{"":"Centered (default)",left:"Left",inline:"Inline"}},table:{category:"Display options"}},url:{control:{type:"text"}},title:{control:{type:"text"}},details:{control:{type:"text"}},button_label:{control:{type:"text"}},button_icon:{control:{type:"text"}},button_align_right:{name:"Align button to right",table:{category:"Display options"}},...c.argTypes}},p=e=>({components:{UidsCta:A},setup(){return{args:e}},template:`
  ...
  \`
})`,...(x=(B=o.parameters)==null?void 0:B.docs)==null?void 0:x.source}}};const K=["Centered","Inline","Left"];export{n as Centered,s as Inline,o as Left,K as __namedExportsOrder,J as default};
