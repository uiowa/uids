import{d as j,g as m,c as r,f as D,a as b,b as _,q as d,j as l,n as h,o as u,e as g,t as y}from"./vue.esm-bundler-BvXj7D1s.js";/* empty css                    */import{_ as U}from"./Headline.vue_vue_type_script_setup_true_lang-BFGUQONp.js";import{_ as V}from"./Button.vue_vue_type_script_setup_true_lang-DTPkAwzt.js";import{B as c}from"./background-DvwhyV5E.js";import{c as f}from"./utlity-CAV5GFHh.js";/* empty css                  */const E={class:"cta__container"},L={key:0,class:"cta__title"},q={key:1,class:"cta__content"},z={key:0,class:"cta__link"},A=j({__name:"Cta",props:{headline_style:{type:String,default:""},url:{type:String},details:{type:String},orientation:{type:String,default:""},button_align_right:{type:Boolean,default:!1},button_label:{type:String},button_icon:{type:String,default:""},...c.props},setup(e){const i=e,I=m(()=>{let t=["cta"];return c.addBackgroundClass(t,i),["button_align_right"].forEach(a=>{i[a]===!0&&t.push(`cta--${f(a)}`)}),i.orientation&&t.push(`cta--${f(i.orientation)}`),t}),N=m(()=>[""]);return(t,a)=>(u(),r("div",{class:h(I.value)},[D("div",E,[t.$slots.title?(u(),r("div",L,[b(U,{text_style:e.headline_style},{default:_(()=>[l(t.$slots,"title",{},()=>[a[0]||(a[0]=g("Title"))])]),_:3},8,["text_style"])])):d("",!0),e.details?(u(),r("div",q,[l(t.$slots,"details",{},()=>[g(y(e.details),1)])])):d("",!0)]),e.button_label?(u(),r("footer",z,[b(V,{class:h(N.value),url:e.url,size:"medium"},{default:_(()=>[l(t.$slots,"button_label",{},()=>[g(y(e.button_label),1)]),l(t.$slots,"button_icon")]),_:3},8,["class","url"])])):d("",!0)],2))}}),K={title:"Components/CTA",parameters:{docs:{source:{code:null}}},component:A,tags:["autodocs"],argTypes:{headline_style:{name:"Title style",options:["uppercase","serif",""],control:{type:"select",labels:{uppercase:"Antonio (default)",serif:"Zilla Slab","":"Roboto"}},table:{category:"Display options"}},orientation:{name:"Orientation",options:["","left","inline"],control:{type:"select",labels:{"":"Centered (default)",left:"Left",inline:"Inline"}},table:{category:"Display options"}},url:{control:{type:"text"}},title:{control:{type:"text"}},details:{control:{type:"text"}},button_label:{control:{type:"text"}},button_icon:{control:{type:"text"}},button_align_right:{name:"Align button to right",table:{category:"Display options"}},...c.argTypes}},p=e=>({components:{UidsCta:A},setup(){return{args:e}},template:`
    <uids-cta
      :url="args.url"
  ...
  \`
})`,...(x=(B=o.parameters)==null?void 0:B.docs)==null?void 0:x.source}}};const M=["Centered","Inline","Left"];export{n as Centered,s as Inline,o as Left,M as __namedExportsOrder,K as default};
