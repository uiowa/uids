import{U as w}from"./Headline-5921ba25.js";import"./vue.esm-bundler-c04f16a9.js";/* empty css                 */const F={title:"Components/Headline",parameters:{docs:{source:{code:null}}},component:w,tags:["autodocs"],argTypes:{default:{control:{type:"text"}},level:{control:{type:"select"},options:["h1","h2","h3","h4","h5","h6"]},highlight:{control:{type:"boolean"}},text_style:{type:Boolean,default:!1,options:["","uppercase","serif"],control:{type:"select",labels:{"":"default",uppercase:"Uppercase",serif:"Serif"}}},underline:{control:{type:"boolean"}},url:{control:{type:"text"}},aria_describedby:{control:{type:"text"}},class:{control:{type:"text"}}}},t=T=>({components:{UidsHeadline:w},setup(){return{args:T}},template:`
  ...
  \`
})`,...(x=(v=a.parameters)==null?void 0:v.docs)==null?void 0:x.source}}};var S,H,U;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{originalSource:`args => ({
  // Components used in your story \`template\` are defined in the \`components\` object
  components: {
    UidsHeadline
  },
  ...
  \`
})`,...(U=(H=r.parameters)==null?void 0:H.docs)==null?void 0:U.source}}};const D=["Default","Uppercase","Serif","Underline","Highlight","HighlightedSingleWord"];export{e as Default,a as Highlight,r as HighlightedSingleWord,s as Serif,o as Underline,n as Uppercase,D as __namedExportsOrder,F as default};
