import{i as e}from"./preload-helper-B3w-AgZf.js";import{n as t,t as n}from"./BrandBar-m8ayL44H.js";import{n as r,t as i}from"./BrandBarDocs-Zz4rQK2I.js";var a,o,s,c,l,u,d,f,p;e((()=>{t(),r(),a={title:`Components/Branding/Brand Bar`,component:n,tags:[`autodocs`],argTypes:{narrow:{control:{type:`boolean`}},default:{control:{type:`text`}},second_row_content:{control:{type:`text`}},healthcare:{control:{type:`boolean`}}},parameters:{docs:{source:{code:null},page:i}}},o=e=>({components:{UidsIowaBar:n},setup(){return{args:e}},template:`
