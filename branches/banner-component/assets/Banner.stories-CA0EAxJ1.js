import{d as D,k as b,v as U,c as r,l as c,f as k,n as f,m as d,a as E,b as x,o,p as B,F as O,x as N}from"./vue.esm-bundler--ETYdinE.js";import{_ as q}from"./Button.vue_vue_type_script_setup_true_lang-ChQE5Vxq.js";import{_ as F}from"./Headline.vue_vue_type_script_setup_true_lang-Bzaie0v3.js";import{a as R,_ as j}from"./click-a11y-CyDOAv-Y.js";import{B as y}from"./_background-RctfgKj_.js";import{_ as G,a as Q}from"./ExampleVideoFile-CMyNn3BR.js";import{Primary as s}from"./Button.stories-BLIwEfT1.js";import"./utlity-CAV5GFHh.js";/* empty css               */(function(){const n=matchMedia("(prefers-reduced-motion)");function e(a,i){a&&(this.element=a,this.video=this.element.querySelector("video"),this.video&&(this.video.id=this.video.id+"-"+i,this.video_btn=this.element.querySelector(".video-controls .video-btn"),this.video_btn.id=this.video_btn.id+"-"+i,e.reducedMotionCheck(this.video,this.video_btn),n.addListener(function(){e.reducedMotionCheck(this.video,this.video_btn)}),this.video_btn.addEventListener("click",()=>{e.pausePlay(this.video,this.video_btn)})))}e.reducedMotionCheck=function(a,i){n.matches&&(a.pause(),this.setButtonDataPlay(i))},e.pausePlay=function(a,i){a.paused?(a.play(),e.setButtonDataPaused(i)):(a.pause(),e.setButtonDataPlay(i))},e.setButtonDataPaused=function(a){a.innerHTML="<span class='element-invisible'>Pause</span>",a.classList.remove("video-btn__play"),a.classList.add("video-btn__pause"),a.setAttribute("aria-label","Pause")},e.setButtonDataPlay=function(a){a.innerHTML="<span class='element-invisible'>Play</span>",a.classList.remove("video-btn__pause"),a.classList.add("video-btn__play"),a.setAttribute("aria-label","Play")},window.UidsVideo=e;const u=document.getElementsByClassName("media--video");for(let a=0;a<u.length;a++)new UidsVideo(u[a],a)})();const Z={class:"banner__container"},J={class:"banner__content"},K={key:0,class:"banner__title"},W=["href"],X={key:1,class:"banner__text"},Y={key:2,class:"banner__action"},ee={key:1,class:"bttn--row"},V=D({__name:"Banner",props:{buttons:{type:Array,default:()=>[]},button_color:{type:String,default:"primary",validator:function(n){return["primary","secondary","tertiary","transparent"].indexOf(n)!==-1}},button_light_font:{type:Boolean,default:!1},headline_size:{type:String,default:""},headline_style:{type:String,default:""},headline_highlight:{type:Boolean,default:!1},horizontal_alignment:{type:String,default:""},vertical_alignment:{type:String,default:""},gradient:{type:String,default:"dark",validator:function(n){return["dark","light"].indexOf(n)!==-1}},height:{type:String,default:""},mobile_content_below_image:{type:Boolean,default:!1},background:{type:String,default:""}},setup(n){const e=n,u=b(()=>{let t=["banner"];return y.addBackgroundClass(t,e),e.buttons.length===1&&t.push("click-container"),e.gradient&&e.background===""&&t.push(`banner--gradient-${e.gradient}`),e.height&&t.push(`banner--${e.height}`),e.mobile_content_below_image===!0&&t.push("banner--stacked"),e.horizontal_alignment&&t.push(`banner--horizontal-${e.horizontal_alignment}`),e.vertical_alignment&&t.push(`banner--vertical-${e.vertical_alignment}`),e.horizontal_alignment==="left"?t.push("banner--gradient-left"):t.push("banner--gradient-bottom"),t}),a=b(()=>{const t=["headline","banner__pre-title"];if(e.headline_size&&t.push(`headline--${e.headline_size}`),e.headline_style)switch(e.headline_style){case"uppercase":t.push("headline--uppercase");break;case"serif":t.push("headline--serif");break}return t}),i=b(()=>e.buttons.length>1?!1:e.buttons[0].url||!1);return U(()=>{e.buttons.length>0&&R(".click-container:not([data-uids-no-link])"),document.querySelectorAll(".banner__image.media--video").forEach((v,g)=>{new window.UidsVideo(v,g)})}),(t,v)=>(o(),r("div",{class:f(u.value)},[c(t.$slots,"media"),k("div",Z,[k("div",J,[t.$slots.title||t.$slots.pre_title?(o(),r("header",K,[t.$slots.pre_title?(o(),r("div",{key:0,class:f(a.value)},[c(t.$slots,"pre_title")],2)):d("",!0),E(F,{text_style:n.headline_style,highlight:n.headline_highlight,class:f(`headline--${e.headline_size}`)},{default:x(()=>[i.value?(o(),r("a",{key:0,href:i.value,class:"click-target"},[c(t.$slots,"title")],8,W)):c(t.$slots,"title",{key:1})]),_:3},8,["text_style","highlight","class"])])):d("",!0),t.$slots.default?(o(),r("div",X,[c(t.$slots,"default")])):d("",!0),n.buttons.length>0||t.$slots.buttons?(o(),r("footer",Y,[c(t.$slots,"buttons",{},()=>[n.buttons.length===1?(o(),B(j,{key:0,size:"medium",color:n.button_color,light_font:n.button_light_font,innerHTML:n.buttons[0].label},null,8,["color","light_font","innerHTML"])):n.buttons.length>0?(o(),r("div",ee,[(o(!0),r(O,null,N(n.buttons,(g,te)=>(o(),B(q,{url:g.url,size:"medium",color:n.button_color,light_font:n.button_light_font,innerHTML:g.label},null,8,["url","color","light_font","innerHTML"]))),256))])):d("",!0)])])):d("",!0)])])],2))}}),ue={title:"Components/Banner",parameters:{docs:{source:{code:null}}},component:V,tags:["autodocs"],argTypes:{background_media:{table:{disable:!0}},pre_title:{name:"Pre-title"},title:{name:"Title"},content:{name:"Content"},background:{name:"Background",options:["",...Object.keys(y.allBackgroundOptions)],control:{type:"select",labels:{"":"Image or video",...y.allBackgroundOptions}}},buttons:{name:"Buttons"},button_color:{name:"Button style",control:{type:"select"},options:["primary","secondary","tertiary","transparent"],table:{category:"Buttons"}},button_light_font:{name:"Button light font",control:{type:"boolean"},table:{category:"Buttons"}},headline_size:{name:"Headline size",options:["large","medium","small"],control:{type:"select"},table:{category:"Headline"}},headline_style:{name:"Headline style",options:["uppercase","serif"],control:{type:"select",labels:{uppercase:"Antonio",serif:"Zilla Slab"}},table:{category:"Headline"}},headline_highlight:{name:"Headline highlight",table:{category:"Headline"}},horizontal_alignment:{name:"Horizontal alignment",options:["left","center"],control:{type:"select",labels:{left:"Left",center:"Center"}},table:{category:"Display options"}},vertical_alignment:{name:"Vertical alignment",options:["center","bottom"],control:{type:"select",labels:{center:"Center",bottom:"Bottom"}},table:{category:"Display options"}},gradient:{name:"Gradient",default:"dark",options:["dark","light"],control:{type:"select"},table:{category:"Display options"}},height:{name:"Height",options:["small","medium","large"],control:{type:"select"},table:{category:"Display options"}},mobile_content_below_image:{name:"Content below media (Mobile-only)",control:{type:"boolean"},table:{category:"Display options"}}}},_={render:n=>({components:{UidsBanner:V,ExampleImage:G,ExampleVideoFile:Q},setup(){return{args:n}},template:`
    ...
    >
      ...
      ${n.content}
    </uids-banner>`})},l={..._,args:{background:"",background_media:"<example-image />",pre_title:"University of Iowa",title:"Living on Campus",content:'<p>A member of the <a href="/">Association</a> of American Universities since 1909 and the Big Ten Conference<br> since 1899, the University of Iowa is home to one of the most acclaimed academic medical centers<br> in the country, as well as globally recognized leadership in the study and craft of writing.</p>',headline_style:"serif",headline_highlight:!1,headline_size:"large",horizontal_alignment:"center",vertical_alignment:"center",gradient:"dark",height:"large",mobile_content_below_image:!0,button_light_font:!1,button_color:"primary",buttons:[{...s.args,label:"Read More "+s.args.icon,color:"primary"}]}},m={..._,args:{...l.args,background_media:"<example-video-file />"}},h={..._,args:{...l.args,background:"gold--pattern--particle",background_media:"",gradient:"light"}},p={..._,args:{...l.args,buttons:[{...s.args,label:"Apply "+s.args.icon},{...s.args,label:"Learn More "+s.args.icon,url:"https://uiowa.edu/about"},{...s.args,label:"Explore "+s.args.icon,url:"https://uiowa.edu/explore"}]}};var w,z,S;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...Template,
  args: {
    background: '',
...
}`,...(S=(z=l.parameters)==null?void 0:z.docs)==null?void 0:S.source}}};var $,P,C;m.parameters={...m.parameters,docs:{...($=m.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...Template,
  args: {
    ...BackgroundImage.args,
    background_media: \`<example-video-file />\`
  }
}`,...(C=(P=m.parameters)==null?void 0:P.docs)==null?void 0:C.source}}};var L,M,T;h.parameters={...h.parameters,docs:{...(L=h.parameters)==null?void 0:L.docs,source:{originalSource:`{
  ...Template,
  args: {
    ...BackgroundImage.args,
...
}`,...(T=(M=h.parameters)==null?void 0:M.docs)==null?void 0:T.source}}};var A,H,I;p.parameters={...p.parameters,docs:{...(A=p.parameters)==null?void 0:A.docs,source:{originalSource:`{
  ...Template,
  args: {
    ...BackgroundImage.args,
    buttons: [{
...
}`,...(I=(H=p.parameters)==null?void 0:H.docs)==null?void 0:I.source}}};const ge=["BackgroundImage","BackgroundVideo","BackgroundPattern","MultipleButtons"];export{l as BackgroundImage,h as BackgroundPattern,m as BackgroundVideo,p as MultipleButtons,ge as __namedExportsOrder,ue as default};
