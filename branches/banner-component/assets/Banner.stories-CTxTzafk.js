import{d as Z,s as Q,k as f,B as j,c as s,f as _,p as d,q as o,n as g,a as J,b as k,l as z,o as i,e as u,t as c}from"./vue.esm-bundler-B_OG6i5n.js";import{_ as C}from"./Button.vue_vue_type_script_setup_true_lang--NIkMegI.js";import{_ as K}from"./Headline.vue_vue_type_script_setup_true_lang-Bv-0cPYD.js";import{a as R,_ as X,c as M}from"./122-S3i8Oajx.js";import{B as S}from"./_background-BVWt7A6x.js";import{M as Y}from"./media-PjSUOf2n.js";import"./utlity-CAV5GFHh.js";(function(){const n=matchMedia("(prefers-reduced-motion)");function e(a,l){a&&(this.element=a,this.video=this.element.querySelector("video"),this.video&&(this.video.id=this.video.id+"-"+l,this.video_btn=this.element.querySelector(".video-controls .video-btn"),this.video_btn.id=this.video_btn.id+"-"+l,e.reducedMotionCheck(this.video,this.video_btn),n.addListener(function(){e.reducedMotionCheck(this.video,this.video_btn)}),this.video_btn.addEventListener("click",()=>{e.pausePlay(this.video,this.video_btn)})))}e.reducedMotionCheck=function(a,l){n.matches&&(a.pause(),this.setButtonDataPlay(l))},e.pausePlay=function(a,l){a.paused?(a.play(),e.setButtonDataPaused(l)):(a.pause(),e.setButtonDataPlay(l))},e.setButtonDataPaused=function(a){a.innerHTML="<span class='element-invisible'>Pause</span>",a.classList.remove("video-btn__play"),a.classList.add("video-btn__pause"),a.setAttribute("aria-label","Pause")},e.setButtonDataPlay=function(a){a.innerHTML="<span class='element-invisible'>Play</span>",a.classList.remove("video-btn__pause"),a.classList.add("video-btn__play"),a.setAttribute("aria-label","Play")},window.UidsVideo=e;const v=document.getElementsByClassName("media--video");for(let a=0;a<v.length;a++)new UidsVideo(v[a],a)})();const ee={key:0,class:"video-controls video"},te={key:0,class:"video-btn video-btn__pause",id:"video-btn-pause"},ne={key:1,class:"video-btn video-btn__play",id:"video-btn-play"},ae={class:"banner__container"},ie={class:"banner__content"},le={key:0,class:"banner__title"},oe=["href"],re={key:1,class:"banner__text"},se={key:2,class:"banner__action"},de={key:0,class:"bttn--row"},F=Z({__name:"Banner",props:{url:{type:String},url_2:{type:String},url_3:{type:String},button_label:{type:String},button_label_2:{type:String},button_label_3:{type:String},button_icon:{type:String,default:""},button_color:{type:String,default:"primary",validator:function(n){return["primary","secondary","tertiary","transparent"].indexOf(n)!==-1}},button_light_font:{type:Boolean,default:!1},headline_size:{type:String,default:""},headline_style:{type:String,default:""},content_position:{type:String,default:""},gradient:{type:String,default:""},height:{type:String,default:""},mobile_content_below_image:{type:Boolean,default:!1},enable_autoplay:{type:Boolean,default:!1},media_type:{type:String,default:""},...S.props,...Y.props},setup(n){const e=n,v=Q(),a=f(()=>{let t=["banner"];switch(S.addBackgroundClass(t,e),(e.url||e.url_2)&&t.push("click-container"),e.gradient&&t.push(`banner--gradient-${e.gradient}`),e.height&&t.push(`banner--${e.height}`),e.media_type&&t.push(`banner--${e.media_type}`),e.mobile_content_below_image===!0&&t.push("banner--stacked"),e.content_position){case"center-center":t.push("banner--vertical-center","banner--horizontal-center","banner--gradient-bottom");break;case"center-bottom":t.push("banner--vertical-bottom","banner--horizontal-center","banner--gradient-bottom");break;case"left-center":t.push("banner--vertical-center","banner--horizontal-left","banner--gradient-left");break;case"left-bottom":t.push("banner--vertical-bottom","banner--horizontal-left","banner--gradient-left");break;default:t.push("banner--vertical-center","banner--horizontal-left","banner--gradient-left")}return t}),l=f(()=>{const t=[];if(e.headline_size&&t.push(`headline--${e.headline_size}`),e.gradient==="dark"?t.push("headline--negative"):e.gradient==="light"&&t.push("headline--positive"),e.headline_style)switch(e.headline_style){case"uppercase-highlight":t.push("headline--uppercase","headline--highlight");break;case"serif-highlight":t.push("headline--serif","headline--highlight");break;case"uppercase":t.push("headline--uppercase");break;case"serif":t.push("headline--serif");break}return t});f(()=>!e.url&&!e.url_2&&!e.url_3?null:v.title?"title":e.button_label?"button":v.media?"image":"button");const L=f(()=>e.url&&(e.url_2||e.url_3)?!1:e.url?e.url:e.url_2?e.url_2:e.url_3?e.url_3:!1),B=f(()=>{const t=[];return e.button_light_font&&t.push("bttn--light-font"),e.button_color&&t.push(`bttn--${e.button_color}`),t});return j(()=>{(e.url||e.url_2)&&R(".click-container:not([data-uids-no-link])"),document.querySelectorAll(".banner__image.media--video").forEach((p,O)=>{new window.UidsVideo(p,O)})}),(t,p)=>(i(),s("div",{class:g(a.value)},[_("div",{class:g(["banner__image",{"media--video":n.media_type==="video","media--image":n.media_type!=="video"}])},[d(t.$slots,"media"),n.media_type==="video"?(i(),s("div",ee,[n.enable_autoplay===!0?(i(),s("button",te,p[0]||(p[0]=[_("span",{class:"element-invisible"},"Pause",-1)]))):o("",!0),n.enable_autoplay===!1?(i(),s("button",ne,p[1]||(p[1]=[_("span",{class:"element-invisible"},"Play",-1)]))):o("",!0)])):o("",!0)],2),_("div",ae,[_("div",ie,[t.$slots.title||t.title?(i(),s("header",le,[_("div",{class:g([l.value,"banner__pre-title","headline"])},[d(t.$slots,"pre_title",{},()=>[u(c(t.pre_title),1)])],2),J(K,{text_style:n.headline_style,class:g(l.value)},{default:k(()=>[L.value?(i(),s("a",{key:0,href:L.value,class:"click-target"},[d(t.$slots,"title",{},()=>[u(c(t.title),1)])],8,oe)):d(t.$slots,"title",{key:1},()=>[u(c(t.title),1)])]),_:3},8,["text_style","class"])])):o("",!0),t.content?(i(),s("div",re,[d(t.$slots,"content",{},()=>[u(c(t.content),1)])])):o("",!0),n.button_label||n.button_label_2||n.button_label_3?(i(),s("footer",se,[n.url&&(n.url_2||n.url_3)?(i(),s("div",de,[n.url&&n.button_label?(i(),z(C,{key:0,class:g(["bttn",...B.value]),url:n.url,no_default_classes:!0,size:"medium"},{default:k(()=>[d(t.$slots,"button_label",{},()=>[u(c(n.button_label),1)]),d(t.$slots,"button_icon")]),_:3},8,["class","url"])):o("",!0),n.url_2&&n.button_label_2?(i(),z(C,{key:1,class:g(["bttn",...B.value]),url:n.url_2,no_default_classes:!0,size:"medium"},{default:k(()=>[u(c(n.button_label_2)+" ",1),d(t.$slots,"button_icon")]),_:3},8,["class","url"])):o("",!0),n.url_3&&n.button_label_3?(i(),z(C,{key:2,class:g(["bttn",...B.value]),url:n.url_3,no_default_classes:!0,size:"medium"},{default:k(()=>[u(c(n.button_label_3),1)]),_:1},8,["class","url"])):o("",!0)])):n.url&&!n.url_2&&!n.url_3?(i(),z(X,{key:1,class:g(B.value)},{default:k(()=>[u(c(n.button_label),1)]),_:1},8,["class"])):o("",!0)])):o("",!0)])])],2))}}),ge="/branches/banner-component/assets/homepage-loop-BGGphxsM.mp4",ye={title:"Components/Banner",parameters:{docs:{source:{code:null}}},component:F,tags:["autodocs"],argTypes:{pre_title:{name:"Pre-title",control:{type:"text"}},title:{name:"Title",control:{type:"text"}},content:{name:"Excerpt",control:{type:"text"}},url:{name:"First link",control:{type:"text"}},url_2:{name:"Second link",control:{type:"text"}},url_3:{name:"Third link",control:{type:"text"}},button_label:{name:"First link text",control:{type:"text"}},button_label_2:{name:"Second link text",control:{type:"text"}},button_label_3:{name:"Third link text",control:{type:"text"}},button_icon:{name:"Button icon",control:{type:"text"}},button_color:{name:"Button style",control:{type:"select"},options:["primary","secondary","tertiary","transparent"],table:{category:"Display options"}},button_light_font:{name:"Button light font",control:{type:"boolean"},table:{category:"Display options"}},headline_size:{name:"Headline size",options:["large","medium","small"],control:{type:"select"},table:{category:"Display options"}},headline_style:{name:"Headline options",options:["uppercase","uppercase-highlight","serif","serif-highlight",""],control:{type:"select",labels:{uppercase:"Antonio","uppercase-highlight":"Antonio highlighted",serif:"Zilla Slab","serif-highlight":"Zilla Slab highlighted"}},table:{category:"Display options"}},content_position:{name:"Content Position",options:["center-center","center-bottom","left-center","left-bottom"],control:{type:"select",labels:{"center-bottom":"Centered horizontally and bottom-aligned vertically","left-center":"Left-aligned and centered vertically","left-bottom":"Left-aligned horizontally and bottom-aligned vertically","center-center":"Centered horizontally and vertically"}},table:{category:"Display options"}},gradient:{name:"Gradient",options:["dark","light"],control:{type:"select"},table:{category:"Display options"}},height:{name:"Height",options:["small","medium","large"],control:{type:"select"},table:{category:"Display options"}},mobile_content_below_image:{name:"[Mobile] Content Below Image/Video",control:{type:"boolean"},table:{category:"Display options"}},enable_autoplay:{name:"Enable autoplay for video",control:{type:"boolean"},table:{category:"Media"}},media:{name:"Media",control:"text",table:{category:"Media"}},media_type:{name:"Media type",options:["","video"],control:{type:"select",labels:{"":"Image (default)",video:"Video"}},table:{category:"Media"}},media_poster:{name:"Media poster",control:{type:"text"},table:{category:"Media"}},section_background:{name:"Section background",options:["","bg--black","bg--black--pattern--brain","bg--black--pattern--community","bg--black--pattern--particle","bg--gold","bg--gold--pattern--brain","bg--gold--pattern--community","bg--gold--pattern--particle","bg--gray","bg--gray--pattern--brain","bg--gray--pattern--community","bg--gray--pattern--particle","bg--white","bg--white--pattern--brain","bg--white--pattern--community","bg--white--pattern--particle"],control:{type:"select",labels:{"":"- None -","bg--black":"Black","bg--black--pattern--brain":"Black - Brain pattern","bg--black--pattern--community":"Black - Community pattern","bg--black--pattern--particle":"Black - Particle pattern","bg--gold":"Gold","bg--gold--pattern--brain":"Gold - Brain pattern","bg--gold--pattern--community":"Gold - Community pattern","bg--gold--pattern--particle":"Gold - Particle pattern","bg--gray":"Gray","bg--gray--pattern--brain":"Gray - Brain pattern","bg--gray--pattern--community":"Gray - Community pattern","bg--gray--pattern--particle":"Gray - Particle pattern","bg--white":"White","bg--white--pattern--brain":"White - Brain pattern","bg--white--pattern--community":"White - Community pattern","bg--white--pattern--particle":"White - Particle pattern"}},table:{category:"Container"}},...S.argTypes}},w=n=>({components:{UidsBanner:F},setup(){return{args:n}},template:`
  ...
  \`
})`,...(D=($=r.parameters)==null?void 0:$.docs)==null?void 0:D.source}}};var x,U,V;b.parameters={...b.parameters,docs:{...(x=b.parameters)==null?void 0:x.docs,source:{originalSource:`args => ({
  components: {
    UidsBanner
  },
  setup() {
