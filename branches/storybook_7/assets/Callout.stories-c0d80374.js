import{d as f,j as h,o as _,b as y,m as b,n as v}from"./vue.esm-bundler-c04f16a9.js";import{B as s}from"./background-34093459.js";import{M as C}from"./media-96bb985f.js";import{c as i}from"./utlity-a0fec18e.js";import{parameters as k}from"./preview-792d85f6.js";const o=["","small","medium","large"],l=["","left","right","center"],w={inline_alignment:{type:String,default:"left",validator:function(e){return l.indexOf(e)!==-1}},inline_size:{type:String,default:"",validator:function(e){return o.indexOf(e)!==-1}}},z={inline_alignment:{name:"Alignment",table:{defaultValue:{summary:l[0]},category:"Display options"},options:l,control:{type:"select",labels:{"":"full width"}}},inline_size:{name:"Size",table:{defaultValue:{summary:o[0]},category:"Display options"},options:o,control:{type:"select",labels:{"":"full width"}}}},S=(e,t)=>{t.inline_size&&e.push(`inline--size-${i(t.inline_size)}`),t.inline_alignment&&e.push(`inline--align-${i(t.inline_alignment)}`)},r={props:w,argTypes:z,addClass:S},p=f({__name:"Callout",props:{...r.props,...s.props,...C.props},setup(e){const t=e,g=h(()=>{let a=["callout"];return s.addBackgroundClass(a,t),r.addClass(a,t),a});return(a,O)=>(_(),y("div",{class:v(g.value)},[b(a.$slots,"default")],2))}}),m=p;p.__docgenInfo={exportName:"default",displayName:"Callout",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/home/runner/work/uids/uids/src/components/callout/Callout.vue"]};const T={title:"Components/Callout",component:m,argTypes:{...s.argTypes,default:{name:"Content",control:{type:"text"}}},parameters:{docs:{source:{code:null}},viewport:{viewports:k.viewport.viewports,defaultViewport:"tablet"}}},x=e=>({components:{UidsCallout:m},setup(){return{args:e}},template:`
    <uids-callout
