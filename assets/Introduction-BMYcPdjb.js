import{h as i,j as e,M as r}from"./iframe-DYyvmaXb.js";import{v as o}from"./package-CidrV1oG.js";import"./preload-helper-CE-n5q09.js";function t(n){const s={code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",ul:"ul",...i(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{}),`
...
`]}),`
`]}),`
`,e.jsx(s.p,{children:"For each component you would like to include, you will need to include the CSS file for that component as well. Refer to component pages for HTML examples."})]})}function h(n={}){const{wrapper:s}={...i(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(t,{...n})}):t(n)}export{h as default};
