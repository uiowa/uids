import{i as e}from"./preload-helper-CaiIZksp.js";import{$ as t,Ct as n,Q as r,X as i,at as a,ft as o,gt as s,it as c,nt as l,ot as u,tt as d,ut as f,xt as p}from"./iframe-qoUpOS3G.js";import{t as m}from"./_background-BmCA1DJT.js";import{n as h,t as g}from"./utlity-KWWK-_yb.js";import{n as _,t as v}from"./background-CGM_KaMW.js";import{n as y,t as b}from"./Button-xSXlyuom.js";import{n as x,t as S}from"./Headline-BbDvJ0BC.js";var C=e((()=>{})),w,T,E,D,O,k,A=e((()=>{i(),C(),m(),x(),y(),_(),h(),w={class:`cta__container`},T={key:0,class:`cta__title`},E={class:`headline__heading`},D={key:1,class:`cta__content`},O={key:0,class:`cta__link`},k=u({__name:`Cta`,props:{headline_style:{type:String,default:``},url:{type:String},details:{type:String},orientation:{type:String,default:``},button_align_right:{type:Boolean,default:!1},button_label:{type:String},button_icon:{type:String,default:``},...v.props},setup(e){let i=e,u=r(()=>{let e=[`cta`];return v.addBackgroundClass(e,i),[`button_align_right`].forEach(t=>{i[t]===!0&&e.push(`cta--${g(t)}`)}),i.orientation&&e.push(`cta--${g(i.orientation)}`),e}),m=r(()=>[``]);return(r,i)=>(f(),l(`div`,{class:p(u.value)},[t(`div`,w,[r.$slots.title?(f(),l(`div`,T,[a(S,{text_style:e.headline_style},{default:s(()=>[t(`span`,E,[o(r.$slots,`title`,{},()=>[i[0]||=c(`Title`,-1)])])]),_:3},8,[`text_style`])])):d(``,!0),e.details?(f(),l(`div`,D,[o(r.$slots,`details`,{},()=>[c(n(e.details),1)])])):d(``,!0)]),e.button_label?(f(),l(`footer`,O,[a(b,{class:p(m.value),url:e.url,size:`medium`},{default:s(()=>[o(r.$slots,`button_label`,{},()=>[c(n(e.button_label),1)]),o(r.$slots,`button_icon`)]),_:3},8,[`class`,`url`])])):d(``,!0)],2))}})})),j,M=e((()=>{A(),A(),j=k})),N,P,F,I,L,R;e((()=>{M(),_(),N={title:`Components/CTA`,parameters:{docs:{source:{code:null}}},component:j,tags:[`autodocs`],argTypes:{headline_style:{name:`Title style`,options:[`uppercase`,`serif`,``],control:{type:`select`,labels:{uppercase:`Antonio (default)`,serif:`Zilla Slab`,"":`Roboto`}},table:{category:`Display options`}},orientation:{name:`Orientation`,options:[``,`left`,`inline`],control:{type:`select`,labels:{"":`Centered (default)`,left:`Left`,inline:`Inline`}},table:{category:`Display options`}},url:{control:{type:`text`}},title:{control:{type:`text`}},details:{control:{type:`text`}},button_label:{control:{type:`text`}},button_icon:{control:{type:`text`}},button_align_right:{name:`Align button to right`,table:{category:`Display options`}},...v.argTypes}},P=e=>({components:{UidsCta:j},setup(){return{args:e}},template:`
    <uids-cta
      :url="args.url"
