import { defineComponent, openBlock, createElementBlock, createElementVNode, unref, computed, resolveComponent, normalizeClass, createVNode, renderSlot, createCommentVNode, createBlock, resolveDynamicComponent, withCtx } from "vue";
var brandBar = "";
var logo = "";
...
const _hoisted_1$3 = { class: "logo logo--tab" };
const _hoisted_2$1 = ["href"];
const _hoisted_3$1 = /* @__PURE__ */ createElementVNode("div", { class: "element-invisible" }, "The University of Iowa", -1);
...
const _sfc_main$2 = {
  name: "uids-iowa-bar",
  components: { UidsLogo: _sfc_main$3 },
  props: {
    narrow: {
      type: Boolean,
      default: false
...
const _hoisted_1$2 = { class: "iowa-bar__container" };
const _hoisted_2 = {
  key: 0,
  class: "iowa-bar__below"
};
const _hoisted_3 = { class: "iowa-bar__container" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("header", {
    ...
    _ctx.$slots.second_row_content ? (openBlock(), createElementBlock("div", _hoisted_2, [
...
var BrandBar = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render]]);
var button = "";
const _hoisted_1$1 = {
  key: 0,
...
export { BrandBar as UidsBrandBar, _sfc_main$1 as UidsButton, _sfc_main as UidsHeadline, _sfc_main$3 as UidsLogo };
