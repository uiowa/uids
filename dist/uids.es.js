...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("header", {
    ...
    _ctx.$slots.second_row_content ? (openBlock(), createElementBlock("div", _hoisted_2$2, [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("a", {
        ...
        renderSlot(_ctx.$slots, "default"),
        __props.arrow ? (openBlock(), createElementBlock("i", _hoisted_2$1)) : createCommentVNode("", true)
      ], 10, _hoisted_1$3);
    };
  }
});
