...
const _hoisted_1$4 = { class: "logo logo--tab" };
...
const _sfc_main$3 = {
  name: "uids-iowa-bar",
  components: { UidsLogo: _sfc_main$4 },
  props: {
    narrow: {
      type: Boolean,
      default: false
...
const _hoisted_1$3 = { class: "iowa-bar__container" };
const _hoisted_2$2 = {
  key: 0,
...
var BrandBar = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render]]);
var button = "";
...
var headings = "";
var headline = "";
const _hoisted_1$1 = ["href", "aria-describedby"];
      ...
      return openBlock(), createBlock(resolveDynamicComponent(__props.level), {
        ...
        default: withCtx(() => [
          __props.url ? (openBlock(), createElementBlock("a", {
            ...
            renderSlot(_ctx.$slots, "default")
          ], 8, _hoisted_1$1)) : renderSlot(_ctx.$slots, "default", { key: 1 })
        ]),
        _: 3
      }, 8, ["class"]);
    };
...
const _hoisted_3 = /* @__PURE__ */ createTextVNode("Title");
const _hoisted_4 = {
  key: 2,
  class: "card__details"
};
const _hoisted_5 = /* @__PURE__ */ createTextVNode("Details");
const _hoisted_6 = /* @__PURE__ */ createTextVNode("Body");
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        _ctx.$slots.title ? (openBlock(), createElementBlock("header", _hoisted_2, [
          createVNode(_sfc_main$1, { url: unref(headlineLink) }, {
            default: withCtx(() => [
        ...
        _ctx.$slots.details ? (openBlock(), createElementBlock("div", _hoisted_4, [
        ...
        __props.url && __props.link_text ? (openBlock(), createElementBlock("footer", _hoisted_7, [
          unref(linkedElement) === "button" ? (openBlock(), createBlock(_sfc_main$2, {
            key: 0,
            url: __props.url,
            size: "medium"
          }, {
            ...
            _: 1
          }, 8, ["url"])) : (openBlock(), createElementBlock("div", _hoisted_8, toDisplayString(__props.link_text), 1))
        ])) : createCommentVNode("", true)
      ], 2);
    };
  }
});
export { BrandBar as UidsBrandBar, _sfc_main$2 as UidsButton, _sfc_main as UidsCard, _sfc_main$1 as UidsHeadline, _sfc_main$4 as UidsLogo };
