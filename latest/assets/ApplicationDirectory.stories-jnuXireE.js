import{i as e}from"./preload-helper-a3j3z2Z5.js";import{t}from"./_background-qpSuANlz.js";import{n,t as r}from"./Button-jfAc2meT.js";import{t as i}from"./_headline-DjFciJ4R.js";import{t as a}from"./_grid-CRqIIx-T.js";import{n as o,t as s}from"./BrandBar-DcpEGuZW.js";import{t as c}from"./form-B8t8VnkQ.js";import{n as l,t as u}from"./ExampleFiltersForm-CjNJPoSW.js";import{n as d,t as f}from"./Menu-DzQcYqMV.js";import{n as p,t as m}from"./_flexbox-CBBXr78F.js";import{n as h,t as g}from"./Table-inU6cOLY.js";var _=e((()=>{})),v,y,b,x,S;e((()=>{t(),p(),i(),c(),_(),m(),a(),n(),o(),h(),d(),l(),v={subcomponents:{ExampleFiltersForm:u},title:`Showcase/Application`,tags:[`!autodocs`],parameters:{layout:`fullscreen`,docs:{source:{code:null}}},argTypes:{showSidebar:{name:`Show sidebar`}}},y=[{label:`Home`,url:`#`,icon:`fas fa-house`},{label:`Directories`,url:`#`,icon:`fas fa-users`,children:[]},{label:`Reports`,url:`#`,icon:`fas fa-file-lines`},{label:`Roles`,url:`#`,icon:`fas fa-user-gear`},{label:`Contact`,url:`#`,icon:`fas fa-mobile-screen`}],b={render:e=>({components:{UidsButton:r,BrandBar:s,UidsTable:g,UidsMenu:f,ExampleFiltersForm:u},setup(){return{args:e,horizontalMenuItems:y}},template:`
      <main>
        <brand-bar
          :narrow='true'
          :healthcare='false'
