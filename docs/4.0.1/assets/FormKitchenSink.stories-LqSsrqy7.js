import{i as e}from"./preload-helper-C0qHgCEd.js";import{n as t,t as n}from"./FormContainer-BExXygp-.js";import{n as r,t as i}from"./FormFieldset-CHKP0TBn.js";import{n as a,t as o}from"./FormCheckboxOrRadioGroup-9qWVEEKi.js";import{i as s,n as c,t as l}from"./FormItem-DR_4P65-.js";var u,d,f,p,m;e((()=>{s(),r(),c(),a(),t(),u={title:`Elements/Form`,parameters:{docs:{source:{code:null}}},tags:[`!autodocs`],argTypes:{compact:{name:`Compact`,table:{category:`Modifiers`}},large:{name:`Large`,table:{category:`Modifiers`}},inline:{name:`Inline`,table:{category:`Modifiers`}},flex:{name:`Flex`,table:{category:`Modifiers`}},required:{name:`Required`,control:{type:`boolean`},table:{category:`States`}}}},d=[{id:`text-permission-yes`,name:`permission`,value:!0,label:`Yes`},{id:`text-permission-no`,name:`permission`,value:!1,label:`No`}],f=[{id:`financial-aid`,name:`interests`,value:`FINANCIAL_AID`,label:`Costs & Financial Aid`},{id:`marching-band`,name:`interests`,value:`MARCHING_BAND`,label:`Hawkeye Marching Band`},{id:`rotc-air-force`,name:`interests`,value:`ROTC_AIR_FORCE`,label:`ROTC - Air Force (Aerospace Studies)`},{id:`rotc-army`,name:`interests`,value:`ROTC_ARMY`,label:`ROTC - Army (Military Science)`},{id:`study-abroad`,name:`interests`,value:`STUDY_ABROAD`,label:`Study Abroad`},{id:`band`,name:`interests`,value:`BAND`,label:`University Concert Bands and Jazz Bands`},{id:`honors`,name:`interests`,value:`HONORS`,label:`University Honors Program`},{id:`veteran-services`,name:`interests`,value:`VETERAN_SERVICES`,label:`Veteran & Military Connected Student Services`}],p={render:e=>({components:{UidsFormFieldset:i,UidsFormItem:l,UidsFormCheckboxOrRadioGroup:o,UidsFormContainer:n},setup(){return{args:e,radioOptions:d,checkboxOptions:f}},template:`
