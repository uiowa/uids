import{i as e}from"./preload-helper-CaiIZksp.js";import{$ as t,Ct as n,Q as r,X as i,Z as a,dt as o,it as s,lt as c,nt as l,ot as u,ut as d,xt as f}from"./iframe-qoUpOS3G.js";import{t as p}from"./_background-BmCA1DJT.js";var m=e((()=>{}));function h(e){let t=document.querySelectorAll(e);Array.prototype.forEach.call(t,e=>{new g(e)}),window.addEventListener(`popstate`,e=>{g.focusAccordionItemByHash()}),g.focusAccordionItemByHash()}var g,_=e((()=>{g=class{constructor(e){let t=e.querySelectorAll(`details`);Array.prototype.forEach.call(t,e=>{e.addEventListener(`toggle`,t=>{this.toggleAccordionItem(e,t.newState===`open`)}),this.getAccordionItemSummary(e).addEventListener(`click`,t=>{this.accordionItemClick(e)})})}accordionItemClick(e){e.setAttribute(`data-accordion-clicked`,!0)}toggleAccordionItem(e,t){if(e.getAttribute(`data-accordion-clicked`))if(e.removeAttribute(`data-accordion-clicked`),t){let t=`#`+this.getAccordionItemSummary(e).id;window.history&&history.pushState&&t!==`#`&&history.replaceState(``,``,t)}else history.replaceState(``,``,null)}getAccordionItemSummary(e){return e.querySelector(`summary`)}static focusAccordionItemByHash(){let e=window.location.hash.substr(1);if(e!==``){let t=document.getElementById(e);t!==null&&t.click()}}}})),v,y,b,x,S,C=e((()=>{i(),m(),_(),p(),v=[`aria-multiselectable`,`aria-owns`],y=[`name`,`open`],b=[`id`],x=[`innerHTML`],S=u({__name:`Accordion`,props:{multiselectable:{type:Boolean,default:!1},label_color:{type:String,default:``,required:!1},items:{type:Array,required:!0}},setup(e){let i=e,u=()=>{let e=[];return i.items.forEach((t,n)=>{e.push(t.id)}),e.join(` `)},p=r(()=>({accordion:!0,"accordion--multi":i.multiselectable,"accordion--white":i.label_color}));return c(()=>{h(`.accordion`)}),(e,r)=>(d(),l(`div`,{class:f(p.value),role:`tablist`,"aria-multiselectable":i.multiselectable?`true`:`false`,"aria-owns":u()},[(d(!0),l(a,null,o(i.items,(e,a)=>(d(),l(`details`,{key:a,class:`accordion__item`,name:i.multiselectable?null:`accordion-collection`,open:e.open,role:`none`},[t(`summary`,{id:e.id,class:`accordion__heading`,role:`tab`},[t(`h2`,null,[r[0]||=t(`i`,{"aria-hidden":`true`,class:`fas fa-chevron-up`,role:`presentation`},null,-1),s(` `+n(e.title),1)])],8,b),t(`div`,{class:`accordion__content`,innerHTML:e.content},null,8,x)],8,y))),128))],10,v))}})})),w,T=e((()=>{C(),C(),w=S})),E,D,O,k,A,j;e((()=>{T(),E={title:`Components/Accordion`,component:w,argTypes:{label_color:{name:`Label color`,options:[``,`white`],control:{type:`select`,labels:{"":`Gray`,white:`White`}}},multiselectable:{control:`boolean`,name:`Multi select`}},render:e=>({setup(){return{args:e}},components:{UidsAccordion:w},template:`
