import{i as e}from"./preload-helper-CaiIZksp.js";import{$ as t,Q as n,X as r,ft as i,it as a,nt as o,ot as s,tt as c,ut as l,xt as u}from"./iframe-qoUpOS3G.js";import{n as d,t as f}from"./utlity-KWWK-_yb.js";var p=e((()=>{})),m,h,g,_,v=e((()=>{r(),p(),d(),m={key:0,class:`alert__icon`},h={class:`fa-stack fa-1x`},g={key:1,"data-dismiss":`alert`},_=s({__name:`Alert`,props:{type:{type:String,default:`info`,validator:e=>[`info`,`success`,`warning`,`danger`].indexOf(e)!==-1},centered:{type:Boolean},iconVisible:{type:Boolean},dismissible:{type:Boolean},verticallyCentered:{type:Boolean}},setup(e){let r=e,s=n(()=>{switch(r.type){case`success`:return`check`;case`warning`:return`exclamation-triangle`;case`danger`:return`exclamation`;default:return`info`}}),d=n(()=>{let e=[`alert`];return r.type&&e.push(`alert--${f(r.type)}`),r.verticallyCentered&&e.push(`alert--vertically-centered`),r.iconVisible&&e.push(`alert--icon`),[`centered`,`dismissible`].forEach(t=>{r[t]===!0&&e.push(`alert--${f(t)}`)}),e});return(e,n)=>(l(),o(`div`,{class:u(d.value)},[r.iconVisible?(l(),o(`div`,m,[t(`span`,h,[n[0]||=t(`span`,{role:`presentation`,class:`fas fa-circle fa-stack-2x`},null,-1),t(`span`,{role:`presentation`,class:u(`fas fa-stack-1x fa-inverse fa-`+s.value)},null,2)])])):c(``,!0),i(e.$slots,`default`,{class:`alert__content`},()=>[n[1]||=a(`Body`,-1)]),r.dismissible?(l(),o(`button`,g,[...n[2]||=[t(`i`,{class:`fas fa-times`},null,-1)]])):c(``,!0)],2))}})})),y,b=e((()=>{v(),v(),y=_})),x,S,C,w,T,E,D;e((()=>{b(),x={title:`Components/Alert`,parameters:{docs:{source:{code:null}}},component:y,tags:[`autodocs`],argTypes:{type:{name:`Type`,options:[`info`,`success`,`warning`,`danger`],control:{type:`select`,labels:{info:`Info`,success:`Success`,warning:`Warning`,danger:`Danger`}},table:{category:`Display options`}},centered:{name:`Centered`,table:{category:`Display options`}},iconVisible:{name:`Display Icon`,table:{category:`Display options`}},dismissible:{name:`Dismissible`,table:{category:`Properties`}},verticallyCentered:{name:`Center Alert Vertically`,table:{category:`Display options`}},default:{name:`Content`,control:{type:`text`},table:{category:`Content`}}}},S=e=>({components:{UidsAlert:y},setup(){return{args:e}},template:`
    <uids-alert
      :type="args.type"
