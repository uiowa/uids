/* empty css             */import{_ as c}from"./FormContainer.vue_vue_type_script_setup_true_lang-Bbhl1C0e.js";import"./iframe-DYyvmaXb.js";import"./preload-helper-CE-n5q09.js";const g={title:"Elements/Form",parameters:{docs:{source:{code:null}}},tags:["!autodocs"],argTypes:{compact:{name:"Compact",control:{type:"boolean"},table:{category:"Modifiers"}},large:{name:"Large",control:{type:"boolean"},table:{category:"Modifiers"}},inline:{name:"Inline",control:{type:"boolean"},table:{category:"Modifiers"}},disabled:{name:"Disabled",control:{type:"boolean"},table:{category:"States"}},error:{name:"Error",control:{type:"boolean"},table:{category:"States"}},required:{name:"Required",control:{type:"boolean"},table:{category:"States"}}}},e={render:o=>({setup(){return{args:o}},components:{UidsFormContainer:c},template:`
